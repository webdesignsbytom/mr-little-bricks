...
function IntroSection({ getNextColor }) {
  return (
    <section className='grid bg-[#333]'>
      <div className='grid container mx-auto px-8 py-12 sm:py-16 sm:px-12 lg:px-24 mb-10'>
        <article className='grid gap-4'>
          ...
          <section className='text-[#f1f1f1] grid gap-10 sm:mt-6 text-lg lg:px-10 xl:px-20'>
            ...
            <p>
              ...
              lost, only multicolored bricks can lead to salvation. Every
              project is a foundation, every detail a piece of the plan. In my
              world, there’s no room for failure—only strategy, order, and the
              will to build. It’s not about fame. It’s not about glory. It’s
              about the bricks… and what you can create with them. Step into the
              shadows, and let’s craft something the world will never forget.
              That's where you fill find me...stacking little bricks together.
            </p>
            <section className='grid lg:grid-cols-3 sm:py-2 xl:pt-6'>
              <div className={`brick b-11x2 mx-auto b-${getNextColor()}`}></div>
              <div className={`rotate-45 brick b-2x2 mx-auto b-${getNextColor()}`}></div>
              <div className={`hidden lg:block brick b-11x2 mx-auto b-${getNextColor()}`}></div>
            </section>
          </section>
        </article>
      </div>
