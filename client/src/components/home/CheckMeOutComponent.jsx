...
function CheckMeOutComponent({ getNextColor }) {
  return (
    <section className='grid bg-gradient-to-b from-colour4 to-colour1'>
      <div className='grid container gap-4 lg:gap-12 px-8 py-12 sm:py-16 sm:px-12 lg:px-24 mx-auto'>
        ...
        <section className='grid sm:grid-cols-2 gap-8 w-full h-full xl:py-10'>
          <div className='max-w-60 lg:max-w-full mx-auto'>
            <img
              src={LegoManImage}
              alt='Mr Little Bricks personal lego person'
            />
          </div>
          <div className='grid gap-2 max-w-60 lg:max-w-full lg:items-center h-fit my-auto mx-auto lg:mx-0 '>
            <div>
              <img
